...
plot((output_close - output_close_r) * 100, pch=19, cex=0.5, xlab="Distance to TE (bp)", ylab="% Enrichment <VARIANT> Relative to Random", ylim=c(-0.0005, 0.0005))
abline(h=0)
dev.off()
...
plot((output_close - output_close_r) * 100, pch=19, cex=0.2, xlab="Distance to TE (bp)", ylab="% Enrichment <VARIANT> Relative to Random", bty="l", ylim=c(-0.0005, 0.0005))
abline(h=0)
